  ...
  return (
    <div className="product-card group">
      ...
      <div className="relative overflow-hidden">
        ...
        {/* Quick Add Button */}
        <div className="absolute bottom-0 left-0 right-0 bg-brings-primary/90 text-white py-2 flex justify-center transform translate-y-full group-hover:translate-y-0 transition-transform duration-200">
      ...
      <div className="p-4">
        ...
        <div className="flex justify-between items-center mt-2">
          ...
          <Button size="sm" className="bg-brings-primary hover:bg-brings-primary/90 text-white h-8 w-8 p-0 rounded-full">
