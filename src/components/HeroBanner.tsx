...
const HeroBanner = () => {
  return <div className="relative bg-gradient-to-r from-brings-dark to-brings-dark/90 overflow-hidden text-white">
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative flex justify-center items-center">
            ...
            <img src="https://images.unsplash.com/photo-1621447504864-d8686e12698c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1074&q=80" alt="Snacks und Getränke" className="rounded-lg shadow-xl object-cover w-full aspect-[4/3] relative z-10" />
