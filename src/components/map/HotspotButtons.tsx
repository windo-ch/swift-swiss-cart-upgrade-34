  ...
  return (
    <div className="mt-8">
      <div className="bg-brings-dark/5 rounded-lg p-6">
        <h3 className="text-lg font-semibold mb-3 text-brings-dark">Hotspots (Gratis Lieferig)</h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {hotspots.map((hotspot) => (
            <Button
              ...
              variant="outline"
              className="h-auto py-4 px-4 flex flex-col items-center gap-2 hover:bg-brings-primary hover:text-white group"
            >
